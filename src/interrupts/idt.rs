...
pub fn init() {
    let exc_stubs: [usize; 32] = [
        exc0_stub  as *const () as usize, exc1_stub  as *const () as usize, exc2_stub  as *const () as usize, exc3_stub  as *const () as usize,
        exc4_stub  as *const () as usize, exc5_stub  as *const () as usize, exc6_stub  as *const () as usize, exc7_stub  as *const () as usize,
        exc8_stub  as *const () as usize, exc9_stub  as *const () as usize, exc10_stub as *const () as usize, exc11_stub as *const () as usize,
        exc12_stub as *const () as usize, exc13_stub as *const () as usize, exc14_stub as *const () as usize, exc15_stub as *const () as usize,
        exc16_stub as *const () as usize, exc17_stub as *const () as usize, exc18_stub as *const () as usize, exc19_stub as *const () as usize,
        exc20_stub as *const () as usize, exc21_stub as *const () as usize, exc22_stub as *const () as usize, exc23_stub as *const () as usize,
        exc24_stub as *const () as usize, exc25_stub as *const () as usize, exc26_stub as *const () as usize, exc27_stub as *const () as usize,
        exc28_stub as *const () as usize, exc29_stub as *const () as usize, exc30_stub as *const () as usize, exc31_stub as *const () as usize,
    ];

    let irq_stubs: [usize; 16] = [
        irq32_stub as *const () as usize, irq33_stub as *const () as usize, irq34_stub as *const () as usize, irq35_stub as *const () as usize,
        irq36_stub as *const () as usize, irq37_stub as *const () as usize, irq38_stub as *const () as usize, irq39_stub as *const () as usize,
        irq40_stub as *const () as usize, irq41_stub as *const () as usize, irq42_stub as *const () as usize, irq43_stub as *const () as usize,
        irq44_stub as *const () as usize, irq45_stub as *const () as usize, irq46_stub as *const () as usize, irq47_stub as *const () as usize,
    ];
    ...
    unsafe {
        ...
        // ── Syscall handler ───────────────────────────────────────────────────────
        (*idt_ptr)[128].set(isr128_stub as *const () as usize, cs_sel, gate | 0x60); // 0x60 = DPL 3 (userspace)
